        ...
        <div class="row g-0 container mx-auto">
            @if (count($orderLists) > 0)
                <div class="d-flex align-items-center my-3">
                    <a href="{{ route('book#all') }}" class="text-dark me-2"><i
                            class="fas fa-arrow-circle-left fs-5"></i></a>
                    <span class="fs-5 text-dark"><span class="text-success">{{ Auth::user()->name }}</span>'s Order
                        History</span>
                </div>
                <div class="col-12">
                    <table class="w-100">
                        ...
                        @foreach ($orderLists as $list)
                            <tr class="text-center text-dark">
                                ...
                                @endif
                                <td title="view" class="text-primary"><a
                                        href="{{ route('order#list', $list->order_code) }}">
